...
Global.tool.waiting = function(){
	...
	plus.nativeUI.showWaiting("加载中...",{padding:"0",loading:{height:"30px",icon:'images/load.jpg',display:"block",interval:"200"},background:"rgba(0,0,0,0.3)",round:"10px",padlock:true});
};
/*显示加载框*/
...
Global.tool.alertDialog=function(title,text){
	...
	html ='<div class="weui_dialog_confirm" id="dialog1" >'+
          ...
          '<div class="weui_dialog_ft">'+
           ...
           ' <a href="javascript:void(0);" class="weui_btn_dialog primary _sure"style="padding:.3rem">兑换</a>'+
       	'</div>'+
   		'</div>'+
		'</div>'
		 $("body").append(html);
